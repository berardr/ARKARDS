...
namespace HoloToolkit.MRDL.PeriodicTable
{
    public class Element : MonoBehaviour
    {
        ...
        /*public Atom Atom; take out atom replace with basic object for clearance*/ 
        ...
        public void Dim() //dim materials did not transfer we don't really need Dim so I took it out
        {
            if (ActiveElement == this)
                return;
        ...
        public void SetFromElementData(ElementData data, Dictionary<string, Material> typeMaterials)
        {
            ...
            } //not going to need this unless we want to change tag colors before and after clearance? Clearance Level?
